...
" Last Change: 2002-10-01
" Version: 0.6
" URI: http://vim.sourceforge.net/script.php?script_id=368
...
highlight PreProc       guifg=SkyBlue1
    "hi Include gui=None guifg=MediumLightSkyBlue1 guibg=bg
    "hi Define gui=None guifg=MediumLightSkyBlue1g guibg=bg
    "hi Macro gui=None guifg=MediumLightSkyBlue1g guibg=bg
    "hi PreCondit gui=None guifg=MediumLightSkyBlue1g guibg=bg
