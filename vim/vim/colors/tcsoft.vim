...
hi Normal       guifg=#000000   guibg=#f0f0f0 "Schwarze Schrift auf weißem Hintergrund

hi Ignore       guifg=bg

hi Comment      guifg=#000099   gui=NONE  "dunkelblau
hi Constant     guifg=#666666   gui=bold    "grau
hi Special      guifg=#FF0000   gui=NONE    "rot
hi Identifier   guifg=#993300   gui=NONE    "rostfarbig
hi Statement    guifg=#FF9900   gui=underline,bold    "orange
...
hi StatusLine   guifg=#000000   gui=reverse "schwarz

hi String       guifg=#000099   gui=italic   " joe
hi Define       guifg=#999900   gui=reverse    " joe
hi Macro        guifg=#009999   gui=underline    " joe

hi TEMPORARY    guifg=#999900   gui=reverse,italic
