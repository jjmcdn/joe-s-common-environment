# ========================================================================
#  $Id: fns.sh,v 1.4 2009/01/26 12:32:25 joe Exp $
#  $Log: fns.sh,v $
#  Revision 1.4  2009/01/26 12:32:25  joe
#  Many updates.
#
#  aliases:
...
#       send-email command.
#
#  Revision 1.3  2008/01/30 18:32:13  joe
#  - recp failed on files with strange characters or spaces in the names
#  - added remv function.  Pretty much the same as recp with mv as the operation
#    instead of cp, and using the -i flag since --backup isn't supported on all mv
#    implementations I've encountered.
#
#  Revision 1.2  2007/09/27 13:24:59  joe
#  - adding my csfind function to make the line-oriented interface to cscope
#    easier to use.
#
...
#
#
# Functions that are useful pretty much anywhere in just about any
# reasonably sh-like shell.
# ========================================================================
# ------------------------------------------------------------------------
